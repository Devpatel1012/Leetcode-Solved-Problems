class Solution:
    def countTrapezoids(self, A: List[List[int]]) -> int:
        ...
        # See all the patterns and understand the working not done by yourself so make sure next time you understand the problem and then start by yourself and also make sure to understand why we have to use the slops,lines, mid and midlines makesure this!!